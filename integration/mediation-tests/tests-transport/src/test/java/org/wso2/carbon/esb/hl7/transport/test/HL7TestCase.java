...
public class HL7TestCase extends ESBIntegrationTest {
    ...
    @Test(groups = { "wso2.esb" },
            description = "testing application ack")
    public void testHLProxyApplicationAck() throws Exception {

        Utils.deploySynapseConfiguration(addHL7ApplicationAckProxy(), "HL7ApplicationAckProxy",
                                         Utils.ArtifactType.PROXY, false);
        ...
        Utils.undeploySynapseConfiguration("HL7ApplicationAckProxy", Utils.ArtifactType.PROXY, false);
    }

    private OMElement addHL7ApplicationAckProxy() throws Exception {

        return AXIOMUtil.stringToOM("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
